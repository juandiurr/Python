    ...
    try:
        ...
        if len(sys.argv) > 1 and sys.argv[1] != "continuar":
            ...
            try:
                ...
                print("Para jugar introducir un numero despues de wordle.py, ejemplo:")
                print("python wordle.py 7")
                print("El numero indica la cantidad de letras de la palabra a adivvinar")
                print("Para guardar progreso: ctrl + S")
                print("Para ver intentos restantes: ctrl + Z")
                print("Para continuar juego guardado escribir 'continuar' en lugar de un numero al ejecutar el juego")
                print("Bastante simple ¿no?")
                sys.exit()
    except ValueError:
        print("ERROR")
        sys.exit()
